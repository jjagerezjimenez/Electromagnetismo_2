...
With Cylinder 
     ...
     .InnerRadius "0" 
     .Axis "x" 
     .Xrange "-8.25 + ajuste_fino", "8.25 - ajuste_fino" 
     .Ycenter "0" 
     .Zcenter "0" 
     .Segments "0" 
     .Create 
...
With Cylinder 
     ...
     .InnerRadius "0" 
     .Axis "x" 
     .Xrange "-6.75 + ajuste_fino", "6.75 - ajuste_fino" 
     .Ycenter "7" 
     .Zcenter "0" 
     .Segments "0" 
     .Create 
...
With Cylinder 
     ...
     .InnerRadius "0" 
     .Axis "x" 
     .Xrange "-6 + ajuste_fino", "6 - ajuste_fino" 
     .Ycenter "16" 
     .Zcenter "0" 
     .Segments "0" 
     .Create 
...
With Cylinder 
     ...
     .InnerRadius "0.12" 
     .Axis "x" 
     .Xrange "-0.5 - cilindro", "-5.5 - cilindro" 
     .Ycenter "7" 
     .Zcenter "-3" 
     .Segments "0" 
     .Create 
...
With Cylinder 
     ...
     .InnerRadius "0.02" 
     .Axis "x" 
     .Xrange "-0.5 + corte_cable", "-5.5 +corte_cable" 
     .Ycenter "7" 
     .Zcenter "-3" 
     .Segments "0" 
     .Create 
